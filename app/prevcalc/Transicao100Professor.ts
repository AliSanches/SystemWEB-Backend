...
export const getTransicao100Professor = async (customerId) => {
    ...
    if (cliente.gender === "M") {
        ...
        var idadeNecessaria = 19800;
    } else {
        var totalDiasNecessarios = 9000;
        var idadeNecessaria = 18720;
    }
...
const getIdadeIsOk = (idadeAnos, genero) => {
    ...
    if (genero == "M") requisitoIdade = 55;
    else requisitoIdade = 52;
